...
button = tk.Button(frame_dict['유튜브 댓글 크롤링'], text='크롤링 실행', padx=15, pady=5, command=lambda:youtube_comment_crolling_v1.main(entry.get()))
button.pack()
...
button = tk.Button(frame_dict['유튜브 댓글 좋아요'], text='좋아요 누르기 실행', padx=15, pady=5, command=lambda:youtube_comment_like_v2.main(entry3.get(), entry1.get(), entry2.get()))
